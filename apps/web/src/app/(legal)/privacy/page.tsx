    ...
    <div className="container mx-auto max-w-4xl px-4 py-16">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <section className="mb-8">
          ...
          <p>
            ObbyLabs ("we", "us", or "our") operates diff0, an AI-powered code
            review service. This Privacy Policy explains how we collect, use,
        ...
        <section className="mb-8">
          ...
          <p>
            We process your code temporarily to perform AI reviews. Code is not
            stored permanently after review completion unless required for
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              ...
              us operate (e.g., Convex for database, Dodopayments for payments,
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>OpenAI:</strong> For AI code analysis
            </li>
          </ul>
          <p className="mt-4">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              Code data is processed temporarily and deleted after review
              completion
            </li>
        ...
        <section className="mb-8">
          ...
          <p>
            We operate from the United Arab Emirates. Your data may be
        ...
        <section className="mb-8">
          ...
          <p>
            diff0 is open source software under the MIT License. You can review
            our code on{" "}
            <a
              className="text-primary hover:underline"
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              ...
              <a
                className="text-primary hover:underline"
                href="https://github.com/eersnington/diff0/issues"
                rel="noopener noreferrer"
                target="_blank"
              >
                File an issue
